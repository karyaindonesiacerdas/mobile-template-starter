...
function konvalesen02(props) {
  ...
  return (
    <Container>
      ...
      <Text
        style={{ marginLeft: 30, marginTop: 10, fontSize: 15, color: "black" }}
      >
      ...
      <Text style={styles.descriptionPersyaratan}>3. Berat badan ≥ 45 Kg</Text>
      ...
      <Text style={styles.descriptionPersyaratan}>6. Interval donor</Text>
      <Text style={{ marginLeft: 40, fontSize: 15, color: "black" }}>
