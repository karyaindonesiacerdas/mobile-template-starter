            ...
            <ScrollView>
                ...
                <View
                    ...
                    <Card
                        ...
                        <TouchableOpacity style={styles.button} onPress={goNextPage.bind(this, 'Konvalesen10')} >
                            <Text
                                style={{
                                    margin: 10,
                                    fontSize: 20,
                    ...
                    <Card
                        ...
                        <TouchableOpacity style={styles.button} onPress={goNextPage.bind(this, 'Konvalesen19')} >
                            <Text
                                style={{
                                    margin: 10,
                                    fontSize: 20,
