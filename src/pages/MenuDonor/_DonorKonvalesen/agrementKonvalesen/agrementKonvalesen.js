...
function agrementKonvalesen(props) {
    ...
    const goNextPage = page => {
        if (check1) {
            ...
            Alert.alert(
                'Warning',
                'Centang Informed Consent Donor Konvalesen Terlebih Dahulu',
        ...
        Axios.post(`${API}/pendonor/calon-pendonor/create`, data_calon_donor, {
            ...
            .then(res => {
                ...
                if (res.data.code === 200) {
                    ...
                    kuisoner_calon_donor.kode_calon_pendonor =
                        res.data.kode_pendonor;
        ...
        <Container>
            ...
            <ScrollView>
                ...
                <Text
                    ...
                    diberikan serta menjawab pertanyaan dengan jujur. Saya
                    mengerti dan bersedia menyumbangkan darah dengan volume
                    sesuai standar yang diberlakukan dan setuju diambil contoh
                    darahnya untuk keperluan pemeriksaan laboratorium berupa uji
                    golongan darah, HIV, Hepatitis B, hepatitis C, Sifilis dan
                    infeksi lainnya yang diperlukan saya serta untuk kepentingan
                    penelitian. Bila ternyata hasil pemeriksaan laboratorium
                    perlu ditindaklanjuti, maka saya setuju untuk diberikan
                    kabar tertulis.
                    {'\n'}Jika komponen plasma tidak terpakai untuk transfusi,
                    saya setuju dapat dijadikan produk plasma untuk pengobatan.
                </Text>
                <View
                    style={{
                        marginTop: 20,
