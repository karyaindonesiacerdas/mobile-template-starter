		...
		<Container>
			...
			<ScrollView>
				...
				<View style={styles.viewContainer}>
					...
					<Card style={styles.flowCardRed}>
						<TouchableOpacity>
							<Text style={styles.textInCard}>Pemeriksaan Hb dan golongan darah</Text>
						</TouchableOpacity>
					</Card>
					...
					<Card style={styles.flowCardPeach}>
						<TouchableOpacity>
							...
							>
								Pendonor setelah mendonorkan darah dapat beristirahat sebentar sambil minum air putih
							...
							>
								...
								<Text style={styles.textInCards4}>Menghindari untuk berdiri dalam waktu yang lama</Text>
							</View>
							<View
								style={{
									marginRight: 20,
							...
							>
								...
								<Text style={styles.textInCards4}>
									Jika Anda minum alkohol, sebaiknya Anda tidak minum alkohol sampai 24 jam setelah
									donor
								</Text>
							</View>
							<View
							...
							>
								...
								<Text style={styles.textInCards4}>
									Makan makanan yang mengandung: zat besi tinggi, vitamin C, asamfolat, riboflavin
