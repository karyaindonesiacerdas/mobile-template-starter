      ...
      <ScrollView>
        ...
        <Text style={{ marginLeft:30, marginTop:0,fontSize: 35,fontWeight: "bold",  color: "red" }}>
              ...
              <View style={{marginTop:10,marginLeft:30,marginRight:40, flexDirection: "row",justifyContent: "space-between"}}>
                <View style={{}}><CheckBox title='Lulus Pendaftaran Awal' style={{width:"70%" }} checked={check1}
              onPress={() => setCheck1(!check1)}   />
                 <CheckBox title='Pendaftaran Donor' style={{width:"70%" }} checked={check2}
              onPress={() => setCheck2(!check2)}  />
                </View>             
               
              </View>
              <View style={{marginTop:0,marginLeft:30,marginRight:40, flexDirection: "row",justifyContent:"flex-start" }}>
              <CheckBox title='Status Donor :' style={{width:"70%" }} checked={check3}
              onPress={() => setCheck3(!check3)}  />
                <View style={{marginLeft:40,}}>
                <CheckBox title='Berhasil' style={{width:"70%" }}checked={check4}
              onPress={() => setCheck4(!check4)}   />
                 <CheckBox title='Gagal' style={{width:"70%" }}  checked={check5}
