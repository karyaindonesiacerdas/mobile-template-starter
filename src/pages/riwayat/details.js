                    ...
                    if (r.data.code == 200) {
                        ...
                        if(r.data.data[0].jenis_donor === 'biasa'){
                            if(r.data.data[0].status === 'lolos admin'){
                                ...
                                <TouchableOpacity onPress={() => goNextPage( 'Pilih')}>
                                ...
                                <TouchableOpacity onPress={() => goNextPage( 'Barcode')}>
		...
		<Container>
            ...
            <Card style={styles.flowCardPeach}>
                <TouchableOpacity>
                    ...
                    >
                        <B>Jenis Donor : {detail.jenis_donor.toUpperCase()}</B>
                    </Text>
                    <Text
                        style={{
                            marginBottom: 10,
                    ...
                    >
                        <B>Jadwal Donor :{detail.jadwal_donor.toUpperCase()}</B>
                    </Text>
                    <Text
                        style={{
                            marginBottom: 10,
                    ...
                    >
                        <B>Golongan Darah : {detail.golongan_darah.toUpperCase()}</B>
                    </Text>
                    <Text
                        style={{
                            marginBottom: 10,
                    ...
                    >
                        <B>Berat Badan :{detail.berat_badan.toUpperCase()}</B>
                    </Text>
                </TouchableOpacity>
            </Card>
            {action}
